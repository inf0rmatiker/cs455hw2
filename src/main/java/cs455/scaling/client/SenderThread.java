...
public class SenderThread implements Runnable {
  ...
  public SenderThread(Client client) {
    ...
    byteBuffer = ByteBuffer.allocate(8004);
  }
  ...
  public void run() {
    while (true) {
      ...
      try {
        ...
        // Send the DataPacket's bytes over the SocketChannel using the byteBuffer
        byteBuffer = ByteBuffer.wrap(message.getTotalMessageBytes());
